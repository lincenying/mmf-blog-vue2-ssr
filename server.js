...
function createRenderer(fs) {
    const bundlePath = path.resolve(__dirname, 'dist/server/server-bundle.js')
...
app.get('*', (req, res) => {
    ...
    res.write(`
        ...
        <head>
            ...
            ${process.env.NODE_ENV === 'production' ? `<link rel="stylesheet" href="/dist/css/styles.css">` : ``}
        </head>
        <body>
    `)
    ...
    renderStream.on('end', () => {
        res.end(`
            <script src="/dist/js/client-vendor-bundle.js"></script>
